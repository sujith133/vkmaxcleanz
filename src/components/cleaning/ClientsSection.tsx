...
export default function ClientsSection() {
    return (
        <section className="cz-clients" id="clients">
            <div className="section-wrapper">
                <div className="cz-section-header">
                    <span className="cz-section-label">Our Clients</span>
                    <h2>Trusted by the Best</h2>
                    <p>We are proud to serve these amazing companies and individuals.</p>
                </div>

                <div className="cz-clients-grid">
                    {clients.map((client, i) => (
                        <div className="cz-client-card" key={i}>
                            <div className="cz-client-logo-wrap">
                                <img src={client.logo} alt={client.name} loading="lazy" />
                            </div>
                            <h4 className="cz-client-name">{client.name}</h4>
                        </div>
                    ))}
                </div>
            </div>
