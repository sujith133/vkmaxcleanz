...
export default function JoinTeamSection() {
    ...
    // Lock body scroll when modal is cz-open
    useEffect(() => {
        if (isOpen) {
    ...
    return (
        <>
            <section className="cz-join-team" id="cz-join-team">
                <div className="cz-join-team-content">
                    <div className="cz-join-team-text">
                        <p className="cz-join-team-label">
                    ...
                    <button className="cz-btn-join" onClick={() => setIsOpen(true)}>
                        Apply Now
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Enrollment Modal */}
            {isOpen && (
                <div className="cz-enroll-overlay" onClick={(e) => { if (e.target === e.currentTarget) closeModal(); }}>
                    <div className="cz-enroll-modal">
                        {!submitted ? (
                            <>
                                <div className="cz-enroll-modal-header">
                                    <h3>Staff Enrollment Form</h3>
                                    <button className="cz-enroll-close-btn" onClick={closeModal} aria-label="Close">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M18 6L6 18M6 6L18 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </button>
                                </div>
                                <form className="cz-enroll-form" onSubmit={handleSubmit}>
                                    <div className="cz-enroll-row">
                                        <div className="cz-enroll-field">
                                    ...
                                    <button type="submit" className="cz-enroll-submit">
                                        Submit Application
                            ...
                            <div className="cz-enroll-success">
                                <div className="cz-enroll-success-icon">
                                ...
                                <button className="cz-enroll-success-close" onClick={closeModal}>Done</button>
                            </div>
                        )}
                    </div>
                </div>
